...
@Table(schema = "audit", name = "usuarios",
       uniqueConstraints = @UniqueConstraint(name = "uq_usuarios_email_por_org",
           columnNames = {"organizacao_id", "email"}))
public class Usuario {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "usuarios_seq")
    @SequenceGenerator(name = "usuarios_seq", sequenceName = "audit.usuarios_id_seq", allocationSize = 1)
    private Long id;
    ...
    @JoinTable(schema = "audit", name = "user_roles",
    ...
    public void setUltimoLoginEm(OffsetDateTime v) { this.ultimoLoginEm = v; }
