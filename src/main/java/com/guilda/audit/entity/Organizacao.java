...
public class Organizacao {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "organizacoes_seq")
    @SequenceGenerator(name = "organizacoes_seq", sequenceName = "audit.organizacoes_id_seq", allocationSize = 1)
    private Long id;
