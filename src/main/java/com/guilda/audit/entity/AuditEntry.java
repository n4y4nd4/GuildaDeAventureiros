...
public class AuditEntry {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "audit_entries_seq")
    @SequenceGenerator(name = "audit_entries_seq", sequenceName = "audit.audit_entries_id_seq", allocationSize = 1)
    private Long id;
